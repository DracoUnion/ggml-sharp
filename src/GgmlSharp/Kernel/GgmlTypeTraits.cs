...
/// filled; quantized rows have BlckSize/TypeSize/ToFloat/FromFloatRef filled per GGML spec.
/// Elementwise ops do NOT use this table — they convert via dedicated f32/f16/bf16/i32 codecs.
/// </summary>
public readonly unsafe struct GgmlTypeTraits
{
    ...
    private static GgmlTypeTraits[] Build()
    {
        ...
        // Quantized types: BlckSize/TypeSize per GGML spec; ToFloat/FromFloatRef where ported.
        // Non-K types (block size 32/128)
        t[(int)GgmlType.Q1_0]  = new("q1_0",   128, 0,  18, true, GgmlDequant.Q1_0,  GgmlQuant.Q1_0);
        t[(int)GgmlType.Q4_0]  = new("q4_0",    32, 0,  18, true, GgmlDequant.Q4_0,  GgmlQuant.Q4_0);
        t[(int)GgmlType.Q4_1]  = new("q4_1",    32, 0,  20, true, GgmlDequant.Q4_1,  GgmlQuant.Q4_1);
        t[(int)GgmlType.Q5_0]  = new("q5_0",    32, 0,  22, true, GgmlDequant.Q5_0,  GgmlQuant.Q5_0);
        t[(int)GgmlType.Q5_1]  = new("q5_1",    32, 0,  24, true, GgmlDequant.Q5_1,  GgmlQuant.Q5_1);
        t[(int)GgmlType.Q8_0]  = new("q8_0",    32, 0,  34, true, GgmlDequant.Q8_0,  GgmlQuant.Q8_0);
        t[(int)GgmlType.Q8_1]  = new("q8_1",    32, 0,  36, true, GgmlDequant.Q8_1,  GgmlQuant.Q8_1); // ToFloat stubbed in Dequant

        // K-quants (super-block 256)
        t[(int)GgmlType.Q2_K]  = new("q2_K",   256, 0,  84, true, GgmlDequant.Q2_K,  GgmlQuant.Q2_K);
        t[(int)GgmlType.Q3_K]  = new("q3_K",   256, 0, 110, true, GgmlDequant.Q3_K,  GgmlQuant.Q3_K);
        t[(int)GgmlType.Q4_K]  = new("q4_K",   256, 0, 144, true, GgmlDequant.Q4_K,  GgmlQuant.Q4_K);
        t[(int)GgmlType.Q5_K]  = new("q5_K",   256, 0, 176, true, GgmlDequant.Q5_K,  GgmlQuant.Q5_K);
        t[(int)GgmlType.Q6_K]  = new("q6_K",   256, 0, 210, true, GgmlDequant.Q6_K,  GgmlQuant.Q6_K);
        t[(int)GgmlType.Q8_K]  = new("q8_K",   256, 0, 292, true, GgmlDequant.Q8_K,  GgmlQuant.Q8_K);

        // Ternary quants
        t[(int)GgmlType.TQ1_0] = new("tq1_0",  256, 0,  54, true, GgmlDequant.TQ1_0, GgmlQuant.TQ1_0);
        t[(int)GgmlType.TQ2_0] = new("tq2_0",  256, 0,  66, true, GgmlDequant.TQ2_0, GgmlQuant.TQ2_0);

        // IQ (importance-quantized) types
        t[(int)GgmlType.IQ2_XXS] = new("iq2_xxs", 256, 0,  66, true, GgmlDequant.IQ2_XXS, GgmlQuant.IQ2_XXS);
        t[(int)GgmlType.IQ2_XS]  = new("iq2_xs",  256, 0,  74, true, GgmlDequant.IQ2_XS,  GgmlQuant.IQ2_XS);
        t[(int)GgmlType.IQ3_XXS] = new("iq3_xxs", 256, 0,  98, true, GgmlDequant.IQ3_XXS, GgmlQuant.IQ3_XXS);
        t[(int)GgmlType.IQ1_S]   = new("iq1_s",   256, 0,  50, true, GgmlDequant.IQ1_S,   GgmlQuant.IQ1_S);
        t[(int)GgmlType.IQ4_NL]  = new("iq4_nl",   32, 0,  18, true, GgmlDequant.IQ4_NL,  GgmlQuant.IQ4_NL);
        t[(int)GgmlType.IQ3_S]   = new("iq3_s",   256, 0, 110, true, GgmlDequant.IQ3_S,   GgmlQuant.IQ3_S);
        t[(int)GgmlType.IQ2_S]   = new("iq2_s",   256, 0,  82, true, GgmlDequant.IQ2_S,   GgmlQuant.IQ2_S);
        t[(int)GgmlType.IQ4_XS]  = new("iq4_xs",  256, 0, 136, true, GgmlDequant.IQ4_XS,  GgmlQuant.IQ4_XS);
        t[(int)GgmlType.IQ1_M]   = new("iq1_m",   256, 0,  56, true, GgmlDequant.IQ1_M,   GgmlQuant.IQ1_M);

        // Microscaling formats
        t[(int)GgmlType.MXFP4] = new("mxfp4",   32, 0,  17, true, GgmlDequant.MXFP4, GgmlQuant.MXFP4);
        t[(int)GgmlType.NVFP4] = new("nvfp4",   64, 0,  36, true, GgmlDequant.NVFP4, GgmlQuant.NVFP4);

        // Deprecated / removed slots (keep enum alignment with GGML)
